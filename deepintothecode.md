...
[bwa-mem2](https://github.com/bwa-mem2/bwa-mem2) is the new implementation of bwa algorithm, by mean diverse low level optimizations "*resulting in up to up to 3.5x and 2.4x speedups on end-to-end compute time over the original BWA-MEM on single thread and single socket of Intel Xeon Skylake processor*" <sup>[1](https://ieeexplore.ieee.org/document/8820962)</sup>.
